$("#labelTitleImage").on('change', function() {
...
$("#removeImage").click(function(e) {
	...
	if($('#uploadPreview').children().length > 0) {
		var uploadButton = $("#labelTitleImage");
		
		$(".thumb-image").remove();
		$("#labelTitleImageHidden").val("");
...
if($('#activityNumber').val() != "") {
	...
	$("<img src='" + $('#labelTitleImageHidden').val() +"' class='thumb-image' />").appendTo(uploadPreview);
