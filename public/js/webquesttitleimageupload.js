$("#webquestTitleImage").on('change', function() {
...
$("#removeImage").click(function(e) {
	...
	if($('#uploadPreview').children().length > 0) {
		var uploadButton = $("#webquestTitleImage");
		
		$(".thumb-image").remove();
		$("#webquestTitleImageHidden").val("");
...
if($('#activityNumber').val() != "") {
	...
	$("<img src='" + $('#webquestTitleImageHidden').val() +"' class='thumb-image' />").appendTo(uploadPreview);
