...
<div class="triviamainbox"><!--  home -->
	...
	<br />
	<button id="startTrivia" ng-click='getScoreType("<?php echo $activityObj[5]; ?>"); getLifelines(<?php echo $activityObj[6]; ?>, <?php echo $activityObj[7]; ?>, <?php echo $activityObj[8]; ?>); startTrivia(<?php echo json_encode($randomized, JSON_HEX_APOS | JSON_HEX_QUOT); ?>)'>Start the Trivia Activity</button>
</div>